  ...
  call
    ~lifecycle:
      [
        ...
        , "Reset the power-state of the VM to halted in the database only. \
           (Used to recover from supporter host failures in pooling scenarios \
           by resetting the power-states of VMs running on unresponsive supporters to \
    ...
    ~doc:
      "Reset the power-state of the VM to halted in the database only. (Used \
       to recover from supporter host failures in pooling scenarios by resetting the \
       power-states of VMs running on unresponsive supporters to halted.) This is a \
